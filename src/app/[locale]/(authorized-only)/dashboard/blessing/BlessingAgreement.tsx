...
export function BlessingAgreement() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-8 md:px-8">
      <div className="flex flex-col justify-center gap-4 max-w-[500px]">
        ...
        <Button
          disabled={
            createProfileMutation.isPending || createProfileMutation.isSuccess
          }
          onClick={() => createProfileMutation.mutate()}
          className="mt-4 px-6 py-2 font-semibold shadow"
          variant="filled"
        >
          {t("agreement_confirm")}
        </Button>
