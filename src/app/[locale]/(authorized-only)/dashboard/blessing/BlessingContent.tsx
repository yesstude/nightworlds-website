      ...
      <div className="flex flex-col items-center gap-4">
        <div className="relative flex h-[128px] w-[128px] items-center justify-center rounded-[24px] bg-primary/10">
          <Icon
            icon="folded_hands"
            size={64}
            className={styles.glowGradientIcon}
          />
          <span
        ...
        <h1
          className={
            "text-[32px] font-bold leading-tight tracking-normal text-foreground " +
            styles.glowGradientText
          }
        >
          {t("title")}
        </h1>
        <p className="max-w-[500px] text-center">{t("description")}</p>
      </div>
        ...
        <Card className="w-full max-w-[380px] bg-primary/5 rounded-[24px]">
          <CardContent className="flex flex-col gap-4 p-0">
            <div className="rounded-[24px] p-6 h-full flex flex-col gap-4">
              ...
              <div className="text-white/90 text-base">example description</div>
            </div>
          </CardContent>
        </Card>
      </div>
