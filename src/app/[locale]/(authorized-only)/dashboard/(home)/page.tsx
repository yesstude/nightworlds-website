...
export const metadata: Metadata = {
  ...
  description:
    "Добро пожаловать в панель управления NightWorlds. Здесь вы можете выбрать мир, узнать как подключиться и управлять своим аккаунтом.",
  openGraph: {
    type: "website",
      ...
      <div className="flex w-full flex-col gap-16 gap-y-4 md:grid md:grid-cols-2">
        <div className="col-span-1 flex h-full flex-col justify-center">
          ...
          <h1 className="mb-4 text-[32px] font-bold leading-tight tracking-normal text-foreground">
            {t("homepage.howtoplay.title")}
          </h1>
          <ol className="list-inside list-decimal leading-relaxed [&_li]:mb-2">
            <li>
              <Link href="/dashboard/worlds" className="underline text-primary">
                {t("homepage.howtoplay.select_world")}
              </Link>
            </li>
            <li>
              {t("homepage.howtoplay.minecraft", {
                version: "1.21.4",
              })}
            </li>
            <li>{t("homepage.howtoplay.multiplayer")}</li>
            <li>{t("homepage.howtoplay.add_server")}</li>
            <li>{t("homepage.howtoplay.add_server_menu")}</li>
          </ol>
